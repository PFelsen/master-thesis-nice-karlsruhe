...
field_order = ["LognormalField","LognormalInclusion", "LognormalMovingInclusion", "MultiphaseField", "RandomShapeField"]
...
"""
Dimension 15:
Level 1: 31 grid points
Level 2: 481 grid points
Level 3: 5,021 grid points
Level 4: 40,001 grid points
Level 5: 261,497 grid points
Level 6: 1,471,297 grid points
Level 7: 7,367,857 grid points
"""
...
field_configs.append({
    "fieldType": LognormalMovingInclusion,
    "kWargs": dict(
        dim=stochDim,
        corrLength=corrLength,
        mu=mu,
...
if rank == 0:
    ...
    output_path = output_dir / f"DarcyUQDim{stochDim}RT{degreeRT}L{meshLevel}.pkl"
